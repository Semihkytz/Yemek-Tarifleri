...
Bu proje, Flutter ile geliştirilmiş zengin arayüzlü bir Yemek Tarifleri mobil uygulamasıdır.
...
1. Depoyu klonla:
   ```bash
   git clone https://github.com/Semihkytz/Yemek-Tarifleri.git
   ```
2. Klasöre gir:
   ```bash
   cd Yemek-Tarifleri
...
---
*Bu proje eğlence ve öğrenme amacıyla tasarlanmıştır.*
